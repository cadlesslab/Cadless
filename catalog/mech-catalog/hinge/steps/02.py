...
# Positioned assembly: two disjoint leaves meshing on the common barrel axis
# (0.2 mm axial gaps between alternating knuckles; no joints/constraints).
# Each body is added as its bare Solid so the geometry summary sees them all.
result = Compound(children=[leaf_fixed.solid(), leaf_swing.solid()])
