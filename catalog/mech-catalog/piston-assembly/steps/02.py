...
# Positioned assembly: two disjoint bodies (the pin floats in the bore with
# 0.05 mm radial clearance; no joints/constraints, positions only). Each body
# is added as its bare Solid so the Compound's geometry summary sees them all.
result = Compound(children=[piston.solid(), wrist_pin.solid()])
