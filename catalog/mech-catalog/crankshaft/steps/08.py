...
params = {
    ...
    "flange_span": (226, 240),
    "flange_radius": 45,
    "bolt_circle_radius": 32,  # 64 mm BCD, matches the flywheel
    "bolt_hole_radius": 4.5,
    "bolt_hole_yz": [(32, 0), (16, 27.7128), (-16, 27.7128),
                     (-32, 0), (-16, -27.7128), (16, -27.7128)],
}
...
# Six flywheel bolt holes through the flange on a 64 mm bolt circle.
for y, z in params["bolt_hole_yz"]:
    hole = Cylinder(radius=params["bolt_hole_radius"], height=20).rotate(Axis.Y, 90)
    part -= Pos((f0 + f1) / 2, y, z) * hole
