...
params = {
    ...
    "cbore_radius": 5,
    "cbore_depth": 5,
    "clamp_hole_radius": 2.75,  # M5 clearance, 5.5 mm diameter
    "clamp_hole_x": 30,
}
...
# Two clamp holes at the ends of the body.
for side in (1, -1):
    hole = Cylinder(
        radius=params["clamp_hole_radius"],
        height=params["body_thickness"] + 2,
        align=(Align.CENTER, Align.CENTER, Align.MIN),
    )
    part -= Pos(side * params["clamp_hole_x"], 0, -1) * hole
