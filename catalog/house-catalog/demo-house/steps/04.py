...
params = {"length": 12, "width": 8, "thickness": 0.3, "wall_height": 3.0, "wall_thickness": 0.3, "door_width": 1.0, "door_depth": 1.0, "door_height": 2.1}
...
result = base + hollow_walls - door_cut + second_floor_slab + second_floor_hollow_walls
