...
# Two cable holes through the back wall, one per bay.
back_y = params["depth"] / 2 - params["wall_thickness"] / 2  # 191, back wall mid-plane
for sx in (1, -1):
    part -= Pos(sx * params["cable_hole_x"], back_y, params["cable_hole_z"]) *         Rot(90, 0, 0) * Cylinder(
            radius=params["cable_hole_diameter"] / 2,
            height=params["wall_thickness"] + 20)
