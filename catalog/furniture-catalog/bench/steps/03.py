...
# Central stretcher rail tying the legs together.
stretcher_length = 2 * leg_x + params["leg_thickness"]  # 1000, spans the legs' outer faces
stretcher_z = params["stretcher_bottom"] + params["stretcher_height"] / 2  # 240
part += Pos(0, 0, stretcher_z) * Box(
    stretcher_length, params["stretcher_width"], params["stretcher_height"])
