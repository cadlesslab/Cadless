...
# Two footrest rails between the leg pairs.
rail_length = 2 * c + params["leg_section"]  # 235, spans the legs' outer faces
rail_z = params["rail_bottom"] + params["rail_height"] / 2  # 265
for sy in (1, -1):
    part += Pos(0, sy * c, rail_z) * Box(
        rail_length, params["rail_section"], params["rail_height"])
