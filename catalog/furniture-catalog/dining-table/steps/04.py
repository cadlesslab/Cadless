...
# Round the tabletop's four vertical corner edges.
top_corners = [e for e in part.edges().filter_by(Axis.Z) if e.center().Z > apron_top]
part = fillet(top_corners, radius=params["top_corner_fillet"])
